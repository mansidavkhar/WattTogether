...
//     useEffect(() => {
//         // If campaign data wasn't passed in state, fetch it from the API
//         if (!campaign) {
...
//         if (didFund) {
//             // Refresh data to show updated funding amount
...
//     const coverImage = campaign.coverImageUrl ? `${BACKEND_URL}${campaign.coverImageUrl}` : 'https://placehold.co/1200x800/201E43/FFFFFF?text=WattTogether';
    
//     const now = new Date();
//     const deadline = new Date(campaign.fundingDeadline);
//     const daysLeft = Math.max(0, Math.ceil((deadline - now) / (1000 * 60 * 60 * 24)));
//     const fundingPercent = Math.min(100, Math.round((campaign.amountRaisedINR / campaign.fundingGoalINR) * 100));
...
//                                 <p>{campaign.aboutEntrepreneur}</p>
//                             </div>
//                         </div>
//                     </div>
...
//                                 <p className="font-bold text-lg">{campaign.fundingType}</p>
//                             </div>
//                             <div className="bg-white p-4 rounded-md shadow-sm text-center">
...
//                                 <p className="font-bold text-lg">{new Date(campaign.fundingDeadline).toLocaleDateString()}</p>
//                             </div>
//                              <div className="bg-white p-4 rounded-md shadow-sm text-center">
//                                 <p className="text-gray-600">Funding Goal</p>
//                                 <p className="font-bold text-lg">₹{campaign.fundingGoalINR.toLocaleString()}</p>
//                             </div>
//                             <div className="bg-white p-4 rounded-md shadow-sm text-center">
//                                 <p className="text-gray-600">Funding Acquired ({fundingPercent}%)</p>
//                                 <p className="font-bold text-lg">₹{campaign.amountRaisedINR.toLocaleString()}</p>
//                             </div>
